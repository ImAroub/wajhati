        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_daySchedules_tripPlans_TripPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaceId = table.Column<int>(type: "int", nullable: false),
                    IsMainPlace = table.Column<bool>(type: "bit", nullable: false),
                    OrderInDay = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_daySchedulePlaces", x => x.Id);
                    table.ForeignKey(
                        name: "FK_daySchedulePlaces_daySchedules_DayScheduleId",
                        column: x => x.DayScheduleId,
                        principalTable: "daySchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_daySchedulePlaces_places_PlaceId",
                        column: x => x.PlaceId,
                        principalTable: "places",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_daySchedulePlaces_DayScheduleId",
                table: "daySchedulePlaces",
                column: "DayScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_daySchedulePlaces_PlaceId",
                table: "daySchedulePlaces",
                column: "PlaceId");

            migrationBuilder.CreateIndex(
                name: "IX_daySchedules_TripPlanId",
                table: "daySchedules",
                column: "TripPlanId");
